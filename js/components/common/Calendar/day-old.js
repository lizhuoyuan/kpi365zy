...
export default class Day extends Component {
  ...
  render() {
    ...
    let star = "";
    if(dayInfo !== undefined && dayInfo !== null){
      holidayName = dayInfo.lunarday;
      if(dayInfo.star !== undefined && dayInfo.star !== null && dayInfo.star !== ""){
        star = dayInfo.star;
        isShowStar  = true;
      }
      if(dayInfo.jieqi !== undefined && dayInfo.jieqi !== null && dayInfo.jieqi !== ""){
        holidayName = dayInfo.jieqi;
        holidayColor="#e02d2d";
      }
      if(showDayInfoHoliday){
         if(dayInfo.festival !== undefined && dayInfo.festival !== null){
          if(dayInfo.festival.lunar !== undefined && dayInfo.festival.lunar !== null && dayInfo.festival.lunar !== ""){
              holidayName = dayInfo.festival.lunar;
              holidayColor="#e02d2d";
          }
          if(dayInfo.festival.solar !== undefined && dayInfo.festival.solar !== null && dayInfo.festival.solar !== ""){
              holidayName = dayInfo.festival.solar;
              holidayColor="#e02d2d";
          }
        }
      }
